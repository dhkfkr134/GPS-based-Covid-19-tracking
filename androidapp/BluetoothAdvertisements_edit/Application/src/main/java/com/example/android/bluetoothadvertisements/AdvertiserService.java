...
public class AdvertiserService extends Service {
    ...
    private void goForeground() {
        ...
        builder.setContentTitle("Advertising device via Bluetooth");
        builder.setContentText("This device is discoverable to others nearby.");
    ...
    private AdvertiseData buildAdvertiseData() {
        ...
        String signalData = "covidddd"; //일단 16바이트(8글짜까진 됨)
