...
public class ScanResultAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        MediaPlayer player = MediaPlayer.create(mContext.getApplicationContext(), R.raw.beep);
        ...
        //test scanresult 대신 scanrecord 로하기.
        ...
        System.out.println("0: " + Byte.toString(servicedata[0]) +
                "1: " + Byte.toString(servicedata[1])
                );
        //내가 이름에 rssi값 붙이기.
