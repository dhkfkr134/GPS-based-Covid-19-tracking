...
public class Requests {
    ...
    //post
    public boolean postData(int userId, String mcode, String loc, String inTime, String outTime, String address){
...
//            builder.addHeader()
    ...
    public String kakaoLogout(String userID, String access_token){
        OkHttpClient client = new OkHttpClient();
        try{
